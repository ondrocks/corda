 ...
 * carpenting
 *
 * @property cc reference to the actual class carpenter we're using to constuct classes
 * @property objects a list of carpented classes, use reflection to access the cosntructor and generate new instances
 */
